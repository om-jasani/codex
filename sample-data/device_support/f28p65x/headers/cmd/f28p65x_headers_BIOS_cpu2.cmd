MEMORY
{
 ...
 PAGE 1:    /* Data Memory */
   ...
   ADCSAFETYINTEVTAGG2        : origin = 0x0005EE40, length = 0x00000040
   ...
   CPU2TOCPU1IPC              : origin = 0x0005CE00, length = 0x00000026
   ...
   LCMCPU2                    : origin = 0x0004C800, length = 0x00000180
   LCMCPU2DMA1                : origin = 0x0004E800, length = 0x00000180
...
UNION run = PIEVECTTABLE
{
   ...
   AdcSafetyIntEvtAgg2RegsFile: > ADCSAFETYINTEVTAGG2, type=NOINIT
   ...
   Cpu2toCpu1IpcRegsFile      : > CPU2TOCPU1IPC, type=NOINIT
   ...
   LCMCPU2RegsFile            : > LCMCPU2, type=NOINIT
   LCMCPU2DMA1RegsFile        : > LCMCPU2DMA1, type=NOINIT
